...
python youtube-dl -x --audio-format mp3 --prefer-free-formats --get-filename -o "%(id)s-%(title)s.%(ext)s" --playlist-start 10 http://www.youtube.com/playlist?list=PL090634BB17919603
